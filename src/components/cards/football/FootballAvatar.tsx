    ...
    >
      <div className="relative flex items-center justify-center">
        ...
        <div className="relative flex h-[238px] w-[238px] items-center justify-center">
          ...
          <div className="absolute left-1/2 top-12 h-0.5 w-10 -translate-x-1/2 rounded-full bg-slate-200/20" />
          <div className="absolute left-1/2 bottom-12 h-0.5 w-10 -translate-x-1/2 rounded-full bg-slate-200/20" />
