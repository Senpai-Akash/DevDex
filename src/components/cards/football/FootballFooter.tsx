...
export function FootballFooter({ edition, branding, cardNumber }: FootballFooterProps) {
  return (
    <footer className="mt-6 flex flex-col gap-4 border-t border-white/10 pt-4 text-[0.68rem] uppercase tracking-[0.25em] text-slate-500 sm:flex-row sm:items-center sm:justify-between">
