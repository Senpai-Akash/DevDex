...
export function RPGBackground() {
  ...
  "
        style={{
          background:
            "radial-gradient(circle at 20% 80%, rgba(255,255,255,.05), transparent 40%), radial-gradient(circle at 80% 20%, rgba(255,255,255,.04), transparent 45%)",
          filter: "blur(40px)",
        }}
      />

      {/* Deep Dark Fantasy Gradients */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(88,28,135,0.22)_0%,_rgba(8,8,8,1)_70%),_radial-gradient(circle_at_bottom,_rgba(127,29,29,0.18)_0%,_rgba(10,10,12,1)_80%)]" />
      ...
      <div
        className="absolute left-1/2 top-[34%] h-[520px] w-[520px]"
        style={{
      ...
      >
        <svg viewBox="0 0 200 200" className="w-full h-full text-purple-500/30">
          ...
          {/* Inner runes */}
          <path
            d="M 100 10 L 100 190 M 10 100 L 190 100 M 36.4 36.4 L 163.6 163.6 M 36.4 163.6 L 163.6 36.4"
            stroke="currentColor"
            strokeWidth="0.5"
            strokeDasharray="2 4"
          />
      ...
      <div className="absolute top-6 left-6 w-16 h-16 opacity-15 text-amber-500/40">
        <svg viewBox="0 0 100 100" className="w-full h-full transform rotate-0">
          <path
            d="M0 0 L100 0 L100 4 L10 10 L10 100 L0 100 Z"
            fill="currentColor"
          />
          <path
            d="M20 20 L80 20 L80 24 L24 24 L24 80 L20 80 Z"
            fill="currentColor"
          />
        </svg>
      </div>
      ...
      {/* Ambient Vignette */}
      <div className="absolute inset-0 bg-[radial-gradient(circle,_transparent_55%,_rgba(0,0,0,0.85)_100%)] opacity-90" />
    </div>
  );
}
