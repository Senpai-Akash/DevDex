...
export function FootballAvatar({ avatar, displayName, role }: FootballAvatarProps) {
  return (
    <section className="mx-auto mb-6 flex w-full max-w-[200px] flex-col items-center text-center">
      <div className="relative h-28 w-28 rounded-full border border-amber-300/15 bg-slate-950 shadow-[0_0_40px_rgba(251,191,36,0.22)]">
